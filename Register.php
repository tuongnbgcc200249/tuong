...
<?php 
   if(isset($_POST['btnRegister'])){
    ...
    if($_POST['slYear']=="0"){
        $err .="<li>Choose year of bitrh, please</li>";
    }
    if($err!=""){
        echo $err;
    }
			 	...
			 	<form id="form1" name="form1" method="post" action="" class="form-horizontal" role="form">
					<div class="form-group">
                       ...
                       <div class="form-group">                               
							...
							<div class="col-sm-10">
							      <input type="text" name="txtFullname" id="txtFullname" value="<?php if(isset($fullname)) echo $fullname; ?>" 
                       ...
                       <div class="form-group">      
							...
							<div class="col-sm-10">
							      <input type="text" name="txtEmail" id="txtEmail" value="<?php if(isset($email)) echo $email; ?>" 
                        ...
                        <div class="form-group">   
							...
							<div class="col-sm-10">
							      <input type="text" name="txtAddress" id="txtAddress" value="<?php if(isset($address)) echo $address; ?>" 
                         ...
                         <div class="form-group">  
							...
							<div class="col-sm-10">
							      <input type="text" name="txtTel" id="txtTel" value="<?php if(isset($tel)) echo $tel; ?>" 
